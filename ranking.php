...
<!-- Mirrored from 104.238.223.59/index.php?Page=Ranking by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Sep 2016 04:13:40 GMT -->
<head>
 <script>(function(d, s, id) {
  ...
  <title>EnigmaGamers - Ranking</title>
 ...
 <body>
  ...
  <div class="global_container_">
      ...
      <div class="acceder-cuenta">
       ...
       <div class="tablero-1-holder">
        RECUPERA TU CONTRASEÑA
			...
			<a href="ranking.php"><div class="IndLink"><font color="cyan">Individual Ranking</font></div></a>
			<a href="warplayer.php"><div class="PWLink">Player Wars Ranking</div></a>
			<div class="CWLink">Clan War Ranking</div>
			<a href="clanwarnormal.php"><div class="CWNormal">Normal</div></a>
			<a href="clanwarsword.php"><div class="CWSword">Sword</div></a>
	...
	<a href="downloads.php">
     ...
     <div class="col-9">
		   		<div class="IndvHeader"></div>
		<div class="RankingHeader"></div> 
		<table style="margin: -5px 16px;width:634px;">
		  <tr><td class="TableRanking" width="40">1</td>
								</tr>   
		</table>     </div>
	      </div>
...
<!-- Mirrored from 104.238.223.59/index.php?Page=Ranking by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Sep 2016 04:14:37 GMT -->
</html>