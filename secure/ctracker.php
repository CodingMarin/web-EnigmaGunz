...
//
  ...
  $wormprotector = array('chr(', 'chr=', 'chr%20', '%20chr', 'wget%20', '%20wget', 'wget(',
                   ...
                   , 'UPDATE','SELECT','SELECT','TRUNCATE','DELETE', 'set name', 'DROP', '/robot.txt' ,'/perl' ,'mod_gzip_status', 'db_mysql.inc', '.inc', 'query', '%27', 'select%20from', 'select from', '//', 'show', '0x', 'cast', 'exec', 'drop%20', 'getenv', 'http_', '_php', 'php_', 'phpinfo()', '<?php', '?>','SQLOpen', ';', "'", '*', 'sql=', 'trim');
