...
function ParseTitle($content)
{
    if($_SESSION[PageTitle] <> "")
    {
        ...
        $r = str_replace("%TITLE%", "AirGamersGunZ - Index", $content);
        //$r = str_replace("src=\"images/", "src=\"http://localhost/", $r);
        return $r;
    }
}
...
<!-- Mirrored from 104.238.223.59/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Sep 2016 04:11:03 GMT -->
<head>
 <script>(function(d, s, id) {
  ...
  <title>EnigmaGamers - Index</title>
  ...
  <div class="global_container_">
	...
	<a href="/downloads.php">
     ...
     <div class="col-9">
		...
		<div class="Slider" style="width:438px;height:188px;position:relative;margin: -114px -5px 0px;">
		<img class="mySlides" src="/images/Slides/1.jpg" style="width:100%;height:100%"><img class="mySlides" src="/images/Slides/2.jpg" style="width:100%;height:100%"><img class="mySlides" src="/images/Slides/3.jpg" style="width:100%;height:100%">		<a class="w3-btn-floating" style="position:absolute;top:45%;left:0" onClick="plusDivs(-1)"><</a>
...
function carousel(n) 
{
    ...
    setTimeout(carousel, 4000);
   	   ...
   	   <div class="cw-centro">
       <div class="bg_news_h-copia-4-holder group">
        <img class="btn_more2-copia" src="/images/btn_more2_copia.jpg" alt="" width="12" height="14">
        <p class="text-21">NEW CLAN WAR</p>
       </div>
	   <div class="layer-holder-3">
						<div class="layer-holder-4">
						 
						</div>
	    </div><div class="layer-holder-5">
						<div class="layer-holder-6">
		  </div>
					   </div><div class="layer-holder-7">
						<div class="layer-holder-8">
						 </div>
	   </div>      </div>     </div>
	       <div class="col group">
      <div class="item-del-momento">
       ...
       <img class="capa-4" src="/images/capa_4.jpg" alt="" width="164" height="32">
	     <table style="width:634px;margin: 20px 80px 0px;"><tr><div class="IOMImage"><a href="/donate.php"><img src="images/shop.gif" width="144" height="104"><div class="IOMTitle">Dt Asasin Colors</div>
						<div class="IOMDesc">
...
<!-- Mirrored from 104.238.223.59/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Sep 2016 04:11:54 GMT -->
</html>